...
{
   if((list->numEntries + 10) >= list->capacity) // if entries are approaching capacity
   {
         ...
         list->capacity = list->capacity * 10;   // change the capacity accordingly with newly resized array (too big?)
   }
